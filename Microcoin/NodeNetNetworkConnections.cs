...
namespace Tests.NodeNetNetworkConnections
{
    ...
    {
        static public NodeNetNetworkConnections? Shared { get; protected set; } = null;
        static protected int portIterator = 9000; // used to give uniq socket port for every nodenet peer
